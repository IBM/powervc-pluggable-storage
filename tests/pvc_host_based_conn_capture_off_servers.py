...
class SvtCaptureTester(svt_tester_base.SvtTesterBase):
    ...
    [TestCase]
    [test_1001_capture_off_servers]
    source_hosts =  <source host from which the VMs would be captured>
    ...
    """
    required_options = [SRV_NAME_PREFIX, SRC_HOST, CONCURRENT_CAPTURES, TIME_DURATION, TIME_UNITS, CAP_NAME_PREFIX]
...
def capture_servers_sub(authTokenId, novaUrl, glanceUrl, curr_stopped_servers, cap_name_prefix,
